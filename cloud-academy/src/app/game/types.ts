...
export const GAME_MODES: GameMode[] = [
  ...
  },
  {
    ...
    title: "Cloud Tycoon",
    icon: "💰",
    description: "Build & manage cloud infrastructure. Earn virtual millions from smart architecture!",
    players: "Solo",
  ...
  },
  {
    ...
    title: "Ticking Bomb",
    icon: "💣",
    description: "Hot potato! Answer correctly to throw the bomb at someone else!",
    players: "2-8 Party",
  ...
  // },
  {
    ...
    title: "Bug Bounty",
    icon: "🐛",
    description: "Hunt for bugs in AWS architectures. Find issues to win cash prizes!",
    players: "Solo",
