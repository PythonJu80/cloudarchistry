...
export function generateCloudFormation(
  ...
  const opts: GeneratorOptions = {
    stackName: options.stackName || "CloudAcademyStack",
  ...
  const template: CloudFormationTemplate = {
    ...
    Description: `Infrastructure stack for ${opts.stackName} (${opts.environment}) - Generated by Cloud Academy`,
    Metadata: {
      "CloudAcademy::Generator": {
        Version: "1.0.0",
